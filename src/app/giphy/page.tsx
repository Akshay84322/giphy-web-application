...
const GiphySearch: React.FC = () => {
  ...
  const GIPHY_API_KEY: string = "5lQZTq5OsYLrfeEtWPOkrDDmz1pDqaTK";
  ...
  return (
    <div className="min-h-screen flex bg-purple-200 flex-col items-center justify-center py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl w-full space-y-8 p-8 bg-pink-100 rounded-lg shadow-md">
        ...
        <div className="flex justify-between">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="block w-700 rounded-lg border-gray-300 bg-gray-100 py-2 px-4 text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
            />
            <button
              onClick={handleSearch}
              className="relative top-0 start-0 bottom-0 px-4 py-2 bg-black text-white rounded-r-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring--500 focus:ring-opacity-50"
            >
              Search
            </button>
            <button
              className="absolute right-0 top-0 text-white mt-4 bg-red-500 hover:bg-red-600 py-2 px-4 rounded-lg"
